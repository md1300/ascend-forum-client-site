import bannerImage from '../../../assets/rb_25442.png'

const Banner = ({searchText,setSearchText,handleSearchSubmit})=> {
    return (
        <div >
            ...
            <div className="flex flex-col w-full ">
              ...
              <form onSubmit={handleSearchSubmit}>
                <div className="flex flex-col mt-8 space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
                    <input  type="text" name='search' className="px-6 py-3 text-gray-700 bg-white border rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring sm:mx-2" placeholder="search for category" onChange={(e)=>{setSearchText(e.target.value)}} value={searchText} />
